...
parser.add_argument('--input_dir', type=str, default='D:/UnderWaterResearch/Codes/Semi-UIR/data/test/Challenge60/input')
parser.add_argument('--output', default='results/Challenge60', help='Location to save checkpoint models')
