...
flags.DEFINE_string("checkpoint_dir", "/content/drive/MyDrive/ucolor/checkpoint", "Name of checkpoint directory [checkpoint]")
...
# filenames = os.listdir('/content/drive/MyDrive/ucolor/input_90') ###### input image dataset
# data_dir = os.path.join(os.getcwd(), 'input_90')
data_dir = '/content/drive/MyDrive/ucolor/input_90'
...
# filenames1 = os.listdir('/content/drive/MyDrive/ucolor/gdcp_90') ###### input transmission dataset
# data_dir1 = os.path.join(os.getcwd(), 'gdcp_90')
data_dir1 = '/content/drive/MyDrive/ucolor/gdcp_90'
...
print('test_data_list1: \t', test_data_list1)
