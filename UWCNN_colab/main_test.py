...
flags.DEFINE_string("checkpoint_dir", "/content/drive/MyDrive/UWCNN/checkpoint", "Name of checkpoint directory [checkpoint]")
...
def main(_):
  ...
  data_dir = '/content/drive/MyDrive/UWCNN_v2/test_real'
