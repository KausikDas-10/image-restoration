...
flags.DEFINE_string("checkpoint_dir", "/content/drive/MyDrive/Water_Net_Code/checkpoint", "Name of checkpoint directory [checkpoint]")
...
def main(_):
    ...
    data_dir = '/content/drive/MyDrive/Water_Net_Code/test_real'
